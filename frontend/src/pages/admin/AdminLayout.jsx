...
const navItems = [
    ...
    { to: '/admin/incubation', label: 'Incubation Hub', icon: '🚀', permission: 'programs.view' },
    { to: '/admin/booster', label: 'Business Booster Kit', icon: '⚡', permission: 'booster.view' },
    ...
    { to: '/admin/assessments', label: 'Test & Assessments', icon: '📝', permission: 'assessments.view' },
    ...
    { to: '/admin/wallets', label: 'Wallet Management', icon: '💰', permission: 'wallets.view' },

...
───────────────────────────────────────────────────────────── */
export async function seedDefaultLegalComplianceServices() {
  try {
    const count = await LegalComplianceServiceModel.countDocuments();
    if (count > 0) return;
    ...
    const defaultServices = [
      {
        ...
        short_description: "Protect your brand name, logo, slogan, and visual identity across India with an official trademark registration.",
        description: "Trademark registration grants you exclusive legal ownership and right to use the brand mark. It prevents competitors and counterfeiters from copying your brand identity, product name, logo, or tagline.",
        fee: 4999,
        currency: "INR",
        ...
        form_fields: [
          ...
          },
          {
            id: "f_brand_name",
            name: "brand_name",
            label: "Proposed Brand / Trademark Name",
            type: "text",
            required: true,
            placeholder: "e.g. REALBELL",
            options: [],
            order: 2,
          },
          {
            ...
            options: ["Individual / Sole Proprietor", "Partnership / LLP", "Private Limited Company", "Public Limited / Trust / Society"],
            order: 3,
          },
          {
            id: "f_trademark_class",
            name: "trademark_class",
            label: "Business Nature / Goods & Services Class",
            type: "text",
            required: true,
            placeholder: "e.g. Software Services (Class 42) or Clothing (Class 25)",
            options: [],
            order: 4,
          },
          {
          ...
          },
          {
            ...
            type: "textarea",
            required: true,
            placeholder: "Complete physical address for communication",
            options: [],
            order: 6,
          },
        ],
        required_documents: [
          {
            id: "doc_pan",
            name: "PAN Card",
            description: "PAN Card of the applicant entity or proprietor (PDF/JPG/PNG)",
            required: true,
          ...
          },
          {
            ...
            description: "Aadhaar Card or Passport of the authorized signatory",
            required: true,
            allowed_types: ["application/pdf", "image/jpeg", "image/png"],
            max_size_mb: 5,
            order: 2,
          ...
          {
            id: "doc_logo",
            name: "Brand Logo / Wordmark Graphic",
            description: "Clear vector or high-resolution image of the logo or wordmark",
            required: true,
          ...
          },
          {
            ...
            description: "Certificate of Incorporation / MSME / GST / Partnership Deed",
            required: false,
            allowed_types: ["application/pdf", "image/jpeg", "image/png"],
            max_size_mb: 10,
            order: 4,
      ...
      },
      {
        ...
        category: "Tax & GST",
        short_description: "Obtain a 15-digit Goods and Services Tax Identification Number (GSTIN) for your business.",
        description: "GST registration is mandatory for businesses exceeding turnover thresholds or conducting interstate commerce. Having a GSTIN allows seamless input tax credit and business credibility.",
        fee: 1499,
        currency: "INR",
        is_payment_required: true,
        ...
        form_fields: [
          ...
          },
          {
            id: "gst_trade_name",
            name: "trade_name",
            label: "Trade Name (If different from legal name)",
            type: "text",
            required: false,
            placeholder: "Operating business name",
            options: [],
            order: 2,
          },
          {
            ...
            options: ["Proprietorship", "Partnership", "Private Limited Company", "Limited Liability Partnership (LLP)"],
            order: 3,
          },
          {
            id: "gst_commencement_date",
          ...
          {
            id: "gst_primary_activity",
            name: "primary_activity",
            label: "Primary Business Activity",
            type: "textarea",
            required: true,
            placeholder: "Description of goods sold or services provided",
            options: [],
            order: 5,
          },
        ],
        required_documents: [
          {
            id: "gst_doc_pan",
            name: "PAN Card",
            description: "PAN Card of Entity / Proprietor / Partners",
            required: true,
            allowed_types: ["application/pdf", "image/jpeg", "image/png"],
            max_size_mb: 5,
            order: 1,
          },
          {
            ...
            description: "Electricity bill, rent agreement with NOC, or property tax receipt",
            required: true,
            allowed_types: ["application/pdf", "image/jpeg", "image/png"],
            max_size_mb: 10,
            order: 2,
          },
          {
            ...
            description: "Cancelled cheque, bank passbook first page, or statement",
            required: true,
            allowed_types: ["application/pdf", "image/jpeg", "image/png"],
            max_size_mb: 5,
            order: 3,
          },
          {
            ...
            description: "Recent color passport-sized photograph",
            required: true,
      ...
      },
      {
        ...
        category: "Corporate",
        short_description: "End-to-end company registration with MCA, DIN, PAN, TAN, MOA, AOA & Certificate of Incorporation.",
        description: "Incorporate your company as a Private Limited entity with Ministry of Corporate Affairs (MCA). Includes name reservation via SPICe+ Part A, drafting MOA & AOA, DIN creation for 2 directors, PAN & TAN allotment.",
        fee: 7999,
        currency: "INR",
        is_payment_required: true,
        ...
        form_fields: [
          {
            ...
            type: "text",
            required: true,
            placeholder: "e.g. RealBell Tech Private Limited",
            options: [],
            order: 1,
          },
          {
            ...
            type: "text",
            required: false,
            placeholder: "Alternative name preference",
            options: [],
            order: 2,
          },
          {
            id: "pvt_directors_count",
            name: "director_count",
            label: "Number of Proposed Directors",
            type: "number",
            required: true,
            placeholder: "Minimum 2 directors",
            options: [],
            order: 3,
          },
          {
            ...
            label: "Proposed Authorized Share Capital (INR)",
            type: "number",
            required: true,
          ...
          },
          {
            id: "pvt_objects",
            name: "main_objects",
            label: "Main Business Objects / Activities",
            type: "textarea",
            required: true,
            placeholder: "Briefly explain the primary business scope",
            options: [],
            order: 5,
          },
        ],
        required_documents: [
          {
            id: "pvt_doc_dir_pan",
            name: "Directors' PAN Cards",
            description: "Self-attested PAN cards of all proposed directors",
            required: true,
            allowed_types: ["application/pdf", "image/jpeg", "image/png"],
            max_size_mb: 10,
            order: 1,
          ...
          {
            id: "pvt_doc_dir_id",
            name: "Directors' ID & Address Proofs",
            description: "Aadhaar / Voter ID / Passport and latest Bank Statement",
            required: true,
            allowed_types: ["application/pdf", "image/jpeg", "image/png"],
            max_size_mb: 10,
            order: 2,
          ...
          {
            id: "pvt_doc_office_proof",
            name: "Registered Office Address Proof",
            description: "Utility Bill (Electricity/Gas) not older than 2 months + Rent Agreement & Owner NOC",
            required: true,
            allowed_types: ["application/pdf", "image/jpeg", "image/png"],
            max_size_mb: 10,
            order: 3,
      ...
      },
      {
        ...
        short_description: "Register for government Udyam MSME certification to unlock subsidies, priority lending, and tender benefits.",
        description: "Official government recognition under Micro, Small, and Medium Enterprises Development Act. Get your Udyam Certificate with zero hassle.",
        fee: 0,
        currency: "INR",
        ...
        form_fields: [
          ...
          },
          {
            ...
            options: ["Proprietary", "Hindu Undivided Family (HUF)", "Partnership", "Private Limited Company", "Society / Trust", "Others"],
            order: 2,
          },
          {
            id: "msme_aadhaar",
          ...
          },
          {
            id: "msme_pan",
            name: "pan_number",
            label: "Enterprise / Proprietor PAN",
            type: "text",
            required: true,
        ...
        required_documents: [
          {
            id: "msme_doc_aadhaar",
            name: "Aadhaar Card",
            description: "Aadhaar card copy of proprietor / authorized director",
            required: true,
            allowed_types: ["application/pdf", "image/jpeg", "image/png"],
            max_size_mb: 5,
            order: 1,
      ...
      },
      {
        ...
        short_description: "Apply for official DPIIT recognition to access tax exemptions (Section 80-IAC, Section 56 Angel Tax), fast-tracked IPR, and government grants.",
        description: "Official Startup India recognition by the Department for Promotion of Industry and Internal Trade (DPIIT). Eligible for 3 consecutive years tax exemption, self-certification for labor and environmental laws, and startup funding programs.",
        fee: 2999,
        currency: "INR",
        is_payment_required: true,
        processing_time: "4-8 Business Days",
        icon: "Rocket",
        status: "active",
        form_fields: [
          {
            id: "dpiit_startup_name",
            name: "startup_name",
            label: "Startup Entity Name",
            type: "text",
            required: true,
          ...
          },
          {
            ...
            options: ["AI & Machine Learning", "Fintech", "Healthtech & Bio", "E-Commerce & Retail", "Edtech", "CleanTech & Energy", "Agritech", "SaaS & Enterprise", "Other"],
            order: 3,
          },
          {
            id: "dpiit_innovation",
            name: "innovation_brief",
            label: "Brief Note on Innovation & Uniqueness",
            type: "textarea",
            required: true,
            placeholder: "Explain how your product/service is innovative or scalable",
            options: [],
            order: 4,
          },
        ],
        required_documents: [
          {
            ...
            description: "Official MCA incorporation certificate",
            required: true,
          ...
          {
            id: "dpiit_doc_deck",
            name: "Pitch Deck / Product Description Note",
            description: "Overview deck explaining the product, market, and innovation",
            required: true,
            allowed_types: ["application/pdf"],
            max_size_mb: 15,
            order: 2,
    ...
    await LegalComplianceServiceModel.insertMany(defaultServices);
    console.log("Seeded default Legal Compliance Services successfully!");
  } catch (err) {
    console.error("seedDefaultLegalComplianceServices error:", err);
  }
}
